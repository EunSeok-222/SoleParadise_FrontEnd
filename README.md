# 🐾발바닥천국🐾
<img src="https://github.com/user-attachments/assets/66f01aed-d588-4b42-a104-4848f26bceb6" width="1100" height="auto" />

## 🧡 프로젝트 소개 
우리의 소중한 반려동물을 위한 쇼핑몰! 🐾<br />
...
진행된 설문조사를 바탕으로 필수 기능인 커머스 시스템 외에도 새로운 기능을 추가했습니다.
...
| **기능 분류**         | **세부 기능**                           |
|-----------------------|---------------------------------------|
| **1️⃣ 커머스 시스템**  | - 상품 조회 및 상세<br> - 장바구니<br> - 주문 및 결제<br> - 결제 내역 조회<br> - 결제 취소 |
| **2️⃣ 나눔 & 커뮤니티** | - 커뮤니티 글 및 사진 등록<br> - 글 목록 조회<br> - 좋아요 |
| **3️⃣ 산책 & 추천**    | - 산책 경로<br> - 산책 일지<br> - 산책 코스 추천 |
| **4️⃣ 실종 등록 & 알림**| - 실종 등록<br> - 실종 알림 |
| **5️⃣ 건강 관리**      | - 건강 관리 등록<br> - 건강 관리 기록 |

## 🧡 WBS-(1)
<img width="1000" alt="wbs" src="https://github.com/user-attachments/assets/2e11573f-c76f-4290-9c85-80eb02fa9ce1" />

## 🧡 WBS-(2)
<img width="1000" alt="wbs" src="https://github.com/user-attachments/assets/feeaf2e0-c859-43b5-b8aa-34a27d6c5586" />
...
<img width="800" alt="시스템 아키텍처" src="https://github.com/user-attachments/assets/e236bb9f-c0bc-4543-9759-603b7a50baac" />

## 🧡 배포 프로세스
<br/>
<img width="800"  alt="배포 프로세스" src="https://github.com/user-attachments/assets/94ea1a5e-7dcf-4206-9c7b-42d228e6bec7" />
